...
echo   Target prefix: log-bulk-demo-
echo ================================================
echo.
...
echo.
echo ================================================
echo ✓ 批量日志删除完成（log-bulk-demo- 前缀）
echo ================================================
echo.
pause
exit /b 0
