...
```powershell
# 转换数据库
mysql -h localhost -u root -p23301144 enterprise_management -e "ALTER DATABASE enterprise_management CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"

# 转换表
mysql -h localhost -u root -p23301144 enterprise_management -e "ALTER TABLE personal_logs CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"

mysql -h localhost -u root -p23301144 enterprise_management -e "ALTER TABLE tasks CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"
```
...
```bash
mysql -h localhost -u root -p23301144 -e "SHOW VARIABLES LIKE 'character_set%';"
```
