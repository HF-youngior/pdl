...
-- 为创始人添加更多任务
INSERT INTO tasks (id, title, description, assignee_id, assignee_name, department_id, priority, status, created_by, deadline, start_time, end_time) VALUES
...
-- 为部门总监添加更多任务
INSERT INTO tasks (id, title, description, parent_task_id, assignee_id, assignee_name, department_id, priority, status, created_by, deadline, start_time, end_time) VALUES
...
-- 添加更多个人日志
INSERT INTO personal_logs (id, user_id, title, content, category, quadrant, related_task_id, is_completed) VALUES
('log-005', 'founder-001', 'Q1季度总结', '完成了Q1季度的业务总结，各部门表现良好', 'work', 'important_urgent', 'task-022', true),
('log-006', 'founder-002', '产品发布会策划', '制定了新产品发布会的详细策划方案', 'work', 'important_not_urgent', 'task-023', false),
('log-007', 'dept-head-001', '绩效考核方案', '制定了新的员工绩效考核方案', 'work', 'important_urgent', 'task-025', true),
('log-008', 'dept-head-002', '审计材料整理', '整理了财务审计所需的所有材料', 'work', 'important_urgent', 'task-026', false),
('log-009', 'team-leader-001', '招聘渠道分析', '分析了各招聘渠道的效果，优化了招聘策略', 'work', 'important_not_urgent', 'task-028', true),
('log-010', 'team-leader-002', '培训课程设计', '设计了新的员工培训课程大纲', 'work', 'important_not_urgent', 'task-029', false),
('log-011', 'employee-001', '面试总结', '完成了Java开发岗位的面试，筛选出3名候选人', 'work', 'important_urgent', 'task-031', true),
('log-012', 'employee-002', '培训材料制作', '制作了销售培训的PPT和手册', 'work', 'important_not_urgent', 'task-032', false),
('log-013', 'employee-005', '财务数据分析', '分析了Q1的财务数据，发现成本控制需要加强', 'work', 'important_urgent', 'task-034', false),
('log-014', 'employee-009', '社交媒体运营', '发布了本周的社交媒体内容，互动率提升了20%', 'work', 'not_important_urgent', 'task-035', true);
...
-- 更新任务进度
UPDATE tasks SET progress_percentage = 100 WHERE id IN ('task-031', 'task-035');
UPDATE tasks SET progress_percentage = 60 WHERE id IN ('task-023', 'task-026', 'task-029', 'task-032', 'task-034');
UPDATE tasks SET progress_percentage = 80 WHERE id IN ('task-025', 'task-027', 'task-028', 'task-030', 'task-033');

-- 设置任务完成时间
UPDATE tasks SET completed_at = '2024-03-05 18:00:00' WHERE id = 'task-031';
UPDATE tasks SET completed_at = '2024-03-06 18:00:00' WHERE id = 'task-035';
