...
-- 增加更多测试数据 - 让月视图更丰富
-- ================================================================
-- 特别为 hr_head (dept-head-001) 用户增加更多数据
-- 时间范围：2025年9-11月
-- ================================================================
...
-- 10月的额外任务（5个）
INSERT INTO tasks (id, title, description, status, priority, color, start_time, end_time, deadline, is_all_day, created_at, created_by, assignee_id, assignee_name, department_id) VALUES
('task-hr-head-oct2', '员工满意度调查', '设计并发放员工满意度调查问卷，收集员工反馈。', 'completed', 'p1', '#4CAF50', NULL, NULL, '2025-10-05 18:00:00', 0, '2025-10-01 09:00:00', '2025-10-05 17:00:00', 'dept-head-001', 'dept-head-001', 'dept-001'),
('task-hr-head-oct3', '完善考勤制度', '根据公司发展需要，完善考勤管理制度，提交审批。', 'completed', 'p2', '#4CAF50', NULL, NULL, '2025-10-10 18:00:00', 0, '2025-10-02 09:00:00', '2025-10-10 16:00:00', 'dept-head-001', 'dept-head-001', 'dept-001'),
('task-hr-head-oct4', '人才库建设', '建立公司人才库系统，录入历史候选人信息。', 'completed', 'p2', '#4CAF50', NULL, NULL, '2025-10-18 18:00:00', 0, '2025-10-05 09:00:00', '2025-10-18 17:00:00', 'dept-head-001', 'dept-head-001', 'dept-001'),
('task-hr-head-oct5', '培训体系规划', '规划2026年度员工培训体系，制定培训计划。', 'in_progress', 'p1', '#FF9800', NULL, NULL, '2025-10-28 18:00:00', 0, '2025-10-10 09:00:00', '2025-10-22 17:00:00', 'dept-head-001', 'dept-head-001', 'dept-001'),
('task-hr-head-oct6', '员工体检安排', '联系体检机构，安排全体员工年度健康体检。', 'completed', 'p2', '#4CAF50', NULL, NULL, '2025-10-31 18:00:00', 0, '2025-10-15 09:00:00', '2025-10-31 16:00:00', 'dept-head-001', 'dept-head-001', 'dept-001');

-- ================================================================
-- 为 hr_head 用户增加更多11月数据
-- ================================================================
...
-- 11月的额外任务（5个）
INSERT INTO tasks (id, title, description, status, priority, color, start_time, end_time, deadline, is_all_day, created_at, created_by, assignee_id, assignee_name, department_id) VALUES
('task-hr-head-nov2', '年终绩效准备', '准备年终绩效考核材料，设计考核表格和流程。', 'in_progress', 'p0', '#FF9800', NULL, NULL, '2025-11-10 18:00:00', 0, '2025-11-01 09:00:00', '2025-11-08 17:00:00', 'dept-head-001', 'dept-head-001', 'dept-001'),
('task-hr-head-nov3', '优化招聘流程', '根据今年的招聘经验，优化招聘流程，提高效率。', 'completed', 'p2', '#4CAF50', NULL, NULL, '2025-11-12 18:00:00', 0, '2025-11-02 09:00:00', '2025-11-12 16:00:00', 'dept-head-001', 'dept-head-001', 'dept-001'),
('task-hr-head-nov4', '员工福利方案', '设计2026年员工福利方案，提升员工满意度和归属感。', 'in_progress', 'p1', '#FF9800', NULL, NULL, '2025-11-18 18:00:00', 0, '2025-11-05 09:00:00', '2025-11-15 17:00:00', 'dept-head-001', 'dept-head-001', 'dept-001'),
('task-hr-head-nov5', '年会筹备', '开始筹备公司年会，包括场地、节目、奖品等安排。', 'pending', 'p1', '#2196F3', NULL, NULL, '2025-11-25 18:00:00', 0, '2025-11-08 09:00:00', '2025-11-08 09:00:00', 'dept-head-001', 'dept-head-001', 'dept-001'),
('task-hr-head-nov6', '人力成本分析', '分析2025年人力成本，为2026年预算提供数据支持。', 'completed', 'p1', '#4CAF50', NULL, NULL, '2025-11-30 18:00:00', 0, '2025-11-10 09:00:00', '2025-11-30 17:00:00', 'dept-head-001', 'dept-head-001', 'dept-001');
...
INSERT INTO tasks (id, title, description, status, priority, color, start_time, end_time, deadline, is_all_day, created_at, created_by, assignee_id, assignee_name, department_id) VALUES
('task-f001-sep2', '业务战略会议', '召开业务战略规划会议，确定下一阶段发展方向。', 'completed', 'p0', '#4CAF50', '2025-09-15 09:00:00', '2025-09-15 17:00:00', '2025-09-15 17:00:00', 1, '2025-09-01 09:00:00', '2025-09-15 18:00:00', 'founder-001', 'founder-001', 'dept-001'),
('task-f001-oct3', '市场拓展计划', '制定Q4市场拓展计划，包括目标客户和营销策略。', 'completed', 'p0', '#4CAF50', NULL, NULL, '2025-10-20 18:00:00', 0, '2025-10-01 09:00:00', '2025-10-20 17:00:00', 'founder-001', 'founder-001', 'dept-001');
...
INSERT INTO tasks (id, title, description, status, priority, color, start_time, end_time, deadline, is_all_day, created_at, created_by, assignee_id, assignee_name, department_id) VALUES
('task-emp1-sep3', '更新招聘渠道', '评估各招聘渠道效果，优化招聘渠道组合。', 'completed', 'p2', '#4CAF50', NULL, NULL, '2025-09-25 18:00:00', 0, '2025-09-10 09:00:00', '2025-09-25 17:00:00', 'employee-001', 'employee-001', 'dept-001'),
('task-emp1-oct3', '招聘数据分析', '整理10月招聘数据，制作月度招聘报表。', 'completed', 'p2', '#4CAF50', NULL, NULL, '2025-10-30 18:00:00', 0, '2025-10-20 09:00:00', '2025-10-30 16:00:00', 'employee-001', 'employee-001', 'dept-001'),
('task-emp1-nov3', '校招宣传准备', '准备校园招聘宣传材料，设计招聘海报。', 'in_progress', 'p1', '#FF9800', NULL, NULL, '2025-11-20 18:00:00', 0, '2025-11-05 09:00:00', '2025-11-15 17:00:00', 'employee-001', 'employee-001', 'dept-001');

-- ================================================================
-- 数据导入完成提示
-- ================================================================
SELECT '✅ 成功增加更多测试数据！' AS message;
SELECT '📊 hr_head 用户新增数据统计：' AS message;
SELECT '   9月：新增5条日志，4个任务' AS detail;
SELECT '   10月：新增6条日志，5个任务' AS detail;
SELECT '   11月：新增7条日志，5个任务' AS detail;
SELECT '🎉 月视图数据现在更加丰富了！' AS message;
