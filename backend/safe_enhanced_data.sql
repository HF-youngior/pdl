...
-- 更新任务进度（使用ON DUPLICATE KEY UPDATE）
INSERT INTO tasks (id, progress_percentage, completed_at) VALUES
('task-031', 100, '2024-03-05 18:00:00'),
('task-035', 100, '2024-03-06 18:00:00'),
('task-023', 60, NULL),
('task-026', 60, NULL),
('task-029', 60, NULL),
('task-032', 60, NULL),
